        ...
        >
            <div className="max-w-6xl mx-auto px-6">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                            AI-powered traffic surveillance for wrong-way detection and number plate recognition. Making roads safer with real-time monitoring.
                        </p>
                    </div>
                ...
                <p className="py-4 text-center text-sm text-gray-400">
                    © {new Date().getFullYear()} <b><span className='text-2xl'>🚦</span>Wrong<span className='text-green-400 text-xl'>WayAI</span></b>. All rights reserved.
                </p>
            </div>
        </motion.footer>
    );
